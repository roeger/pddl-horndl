...
(:predicates
  ...
  (AUX3 ?y0 - object)
  (AUX4 ?y0 - object)
  (AUX5 ?x3 - object ?x1 - object ?x2 - object)
  (AUX6 ?x3 - object ?x1 - object ?x2 - object)
  (AUX7 ?y - object ?x - object)
  (AUX8))
...
(:derived (AUX5 ?x3 - object ?x1 - object ?x2 - object)
...
(:derived (AUX7 ?y - object ?x - object)
          (and (DATALOG_QUERY0 ?x ?y) (not (= ?x ?y))))
(:derived (AUX8)
          (exists (?x ?y - object) (AUX7 ?y ?x)))
(:action hireElectronicEng
  :parameters (?n - object)
  :precondition (not (DATALOG_INCONSISTENT))
  :effect (when (forall (?x1 ?x2 ?x3 - object) (AUX5 ?x3 ?x1 ?x2)) (electronicengineer ?n)))
(:action hireInformaticEng
  :parameters (?n - object)
  :precondition (not (DATALOG_INCONSISTENT))
  :effect (when (forall (?x1 ?x2 ?x3 - object) (AUX6 ?x3 ?x1 ?x2)) (informaticengineer ?n)))
