...
(:predicates
  ...
  (AUX16 ?y0 - object)
  (AUX17 ?y0 - object)
  (AUX18 ?y3 - object ?y2 - object ?y1 - object ?y0 - object)
  ...
  (AUX80 ?f2 - object ?y1 - object ?f1 - object ?y0 - object)
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX18 ?y3 ?y2 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX1 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX10 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX12 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX19 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX2 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX21 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX22 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX23 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX24 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX4 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX7 ?y1 ?y0)) (exists (?y0 - object) (AUX0 ?y0)) (exists (?y0 - object) (AUX11 ?y0)) (exists (?y0 - object) (AUX13 ?y0)) (exists (?y0 - object) (AUX14 ?y0)) (exists (?y0 - object) (AUX15 ?y0)) (exists (?y0 - object) (AUX16 ?y0)) (exists (?y0 - object) (AUX17 ?y0)) (exists (?y0 - object) (AUX20 ?y0)) (exists (?y0 - object) (AUX25 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX5 ?y0)) (exists (?y0 - object) (AUX6 ?y0)) (exists (?y0 - object) (AUX8 ?y0)) (exists (?y0 - object) (AUX9 ?y0))))
...
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX80 ?f2 ?y1 ?f1 ?y0)) (AUX81 ?f2 ?f1)))
...
(:derived (AUX18 ?y3 - object ?y2 - object ?y1 - object ?y0 - object)
...
(:derived (AUX80 ?f2 - object ?y1 - object ?f1 - object ?y0 - object)
