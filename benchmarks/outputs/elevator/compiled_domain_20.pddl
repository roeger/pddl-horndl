...
(:predicates
  ...
  (AUX76 ?f - object)
  (AUX77 ?f - object)
  (AUX78 ?f1 - object ?f2 - object)
  (AUX79 ?y1 - object ?f1 - object ?f2 - object ?y0 - object)
...
(:derived (ins_passenger_closure ?p - object)
          (or (exists (?y0 - object) (AUX31 ?y0 ?p)) (exists (?y0 - object) (AUX32 ?y0 ?p)) (AUX30 ?p) (AUX33 ?p)))
...
(:derived (del_floor ?p - object)
          (or (exists (?y0 - object) (AUX49 ?y0 ?p)) (exists (?y0 - object) (AUX51 ?y0 ?p)) (AUX48 ?p) (AUX50 ?p) (AUX52 ?p) (AUX53 ?p)))
(:derived (ins_floor_closure ?p - object)
          (or (exists (?y0 - object) (AUX55 ?y0 ?p)) (exists (?y0 - object) (AUX56 ?y0 ?p)) (AUX54 ?p)))
(:derived (ins_origin ?p ?f - object)
          (or (AUX57 ?f ?p) (ins_origin_closure ?p ?f)))
(:derived (del_origin ?p ?f - object)
          (or (AUX58 ?f ?p) (AUX59 ?f ?p) (AUX60 ?f ?p) (AUX61 ?f ?p) (AUX62 ?f ?p)))
(:derived (ins_destin ?p ?f - object)
          (or (AUX63 ?f ?p) (ins_destin_closure ?p ?f)))
(:derived (del_destin ?p ?f - object)
          (or (AUX64 ?f ?p) (AUX65 ?f ?p) (AUX66 ?f ?p) (AUX67 ?f ?p) (AUX68 ?f ?p)))
(:derived (ins_liftat ?f - object)
          (or (AUX69 ?f) (AUX70 ?f)))
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX71 ?f ?y0)) (exists (?y0 - object) (AUX73 ?f ?y0)) (AUX72 ?f) (AUX74 ?f) (AUX75 ?f) (AUX76 ?f) (AUX77 ?f)))
(:derived (ins_next ?f1 ?f2 - object)
          (or (AUX78 ?f1 ?f2) (ins_next_closure ?f1 ?f2)))
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX79 ?y1 ?f1 ?f2 ?y0)) (AUX80 ?f1 ?f2)))
...
(:derived (AUX57 ?f - object ?p - object)
...
(:derived (AUX71 ?f - object ?y0 - object)
...
(:derived (AUX78 ?f1 - object ?f2 - object)
          (and (ins_next_request ?f1 ?f2) (not (next ?f1 ?f2))))
(:derived (AUX79 ?y1 - object ?f1 - object ?f2 - object ?y0 - object)
