...
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX72 ?y0 ?f)) (exists (?y0 - object) (AUX73 ?y0 ?f)) (AUX71 ?f) (AUX74 ?f) (AUX75 ?f) (AUX76 ?f) (AUX77 ?f)))
(:derived (ins_next ?f1 ?f2 - object)
          (or (AUX78 ?f1 ?f2) (ins_next_closure ?f1 ?f2)))
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX80 ?f1 ?f2 ?y1 ?y0)) (AUX79 ?f1 ?f2)))
