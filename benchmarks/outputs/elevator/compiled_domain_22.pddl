...
(:predicates
  ...
  (AUX18 ?y1 - object ?y2 - object ?y0 - object ?y3 - object)
...
(:derived (update_aux19)
          (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX18 ?y1 ?y2 ?y0 ?y3)))
...
(:derived (del_floor ?p - object)
          (or (exists (?y0 - object) (AUX49 ?p ?y0)) (exists (?y0 - object) (AUX54 ?p ?y0)) (AUX50 ?p) (AUX51 ?p) (AUX52 ?p) (AUX53 ?p)))
...
(:derived (AUX18 ?y1 - object ?y2 - object ?y0 - object ?y3 - object)
