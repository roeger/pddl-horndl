...
(:derived (ins_passenger_closure ?p - object)
          (or (exists (?y0 - object) (AUX32 ?y0 ?p)) (exists (?y0 - object) (AUX33 ?y0 ?p)) (AUX30 ?p) (AUX31 ?p)))
...
(:derived (del_floor ?p - object)
          (or (exists (?y0 - object) (AUX48 ?y0 ?p)) (exists (?y0 - object) (AUX51 ?y0 ?p)) (AUX49 ?p) (AUX50 ?p) (AUX52 ?p) (AUX53 ?p)))
...
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX71 ?f ?y0)) (exists (?y0 - object) (AUX75 ?f ?y0)) (AUX72 ?f) (AUX73 ?f) (AUX74 ?f) (AUX76 ?f) (AUX77 ?f)))
(:derived (ins_next ?f1 ?f2 - object)
          (or (AUX78 ?f2 ?f1) (ins_next_closure ?f1 ?f2)))
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX80 ?y1 ?f2 ?y0 ?f1)) (AUX79 ?f2 ?f1)))
...
(:derived (AUX48 ?y0 - object ?p - object)
