...
(:predicates
  ...
  (AUX5 ?y2 - object ?y1 - object ?y0 - object ?y3 - object)
  (AUX6 ?y0 - object)
  (AUX7 ?y0 - object)
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX5 ?y2 ?y1 ?y0 ?y3)) (exists (?y0 ?y1 - object) (AUX0 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX10 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX11 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX15 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX16 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX18 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX2 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX24 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX3 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX4 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX8 ?y1 ?y0)) (exists (?y0 - object) (AUX1 ?y0)) (exists (?y0 - object) (AUX12 ?y0)) (exists (?y0 - object) (AUX13 ?y0)) (exists (?y0 - object) (AUX14 ?y0)) (exists (?y0 - object) (AUX17 ?y0)) (exists (?y0 - object) (AUX19 ?y0)) (exists (?y0 - object) (AUX20 ?y0)) (exists (?y0 - object) (AUX21 ?y0)) (exists (?y0 - object) (AUX22 ?y0)) (exists (?y0 - object) (AUX23 ?y0)) (exists (?y0 - object) (AUX25 ?y0)) (exists (?y0 - object) (AUX6 ?y0)) (exists (?y0 - object) (AUX7 ?y0)) (exists (?y0 - object) (AUX9 ?y0))))
...
(:derived (del_origin ?p ?f - object)
          (or (AUX59 ?p ?f) (AUX60 ?f ?p) (AUX61 ?p ?f) (AUX62 ?p ?f) (AUX63 ?p ?f)))
...
(:derived (AUX5 ?y2 - object ?y1 - object ?y0 - object ?y3 - object)
