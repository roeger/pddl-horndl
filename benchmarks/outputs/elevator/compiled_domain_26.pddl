...
(:predicates
  ...
  (AUX11 ?y0 - object ?y1 - object ?y3 - object ?y2 - object)
  (AUX12 ?y0 - object)
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX11 ?y0 ?y1 ?y3 ?y2)) (exists (?y0 ?y1 - object) (AUX0 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX10 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX13 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX17 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX18 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX19 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX20 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX24 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX25 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX6 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX8 ?y0 ?y1)) (exists (?y0 - object) (AUX1 ?y0)) (exists (?y0 - object) (AUX12 ?y0)) (exists (?y0 - object) (AUX14 ?y0)) (exists (?y0 - object) (AUX15 ?y0)) (exists (?y0 - object) (AUX16 ?y0)) (exists (?y0 - object) (AUX2 ?y0)) (exists (?y0 - object) (AUX21 ?y0)) (exists (?y0 - object) (AUX22 ?y0)) (exists (?y0 - object) (AUX23 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX4 ?y0)) (exists (?y0 - object) (AUX5 ?y0)) (exists (?y0 - object) (AUX7 ?y0)) (exists (?y0 - object) (AUX9 ?y0))))
...
(:derived (del_floor ?p - object)
          (or (exists (?y0 - object) (AUX50 ?y0 ?p)) (exists (?y0 - object) (AUX53 ?y0 ?p)) (AUX49 ?p) (AUX51 ?p) (AUX52 ?p) (AUX54 ?p)))
...
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX72 ?y0 ?f)) (exists (?y0 - object) (AUX74 ?y0 ?f)) (AUX73 ?f) (AUX75 ?f) (AUX76 ?f) (AUX77 ?f) (AUX78 ?f)))
...
(:derived (AUX11 ?y0 - object ?y1 - object ?y3 - object ?y2 - object)
