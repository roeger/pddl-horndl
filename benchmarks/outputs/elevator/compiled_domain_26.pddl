...
(:predicates
  ...
  (AUX80 ?y0 - object ?y1 - object ?f1 - object ?f2 - object)
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX6 ?y0 ?y1 ?y3 ?y2)) (exists (?y0 ?y1 - object) (AUX1 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX11 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX12 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX13 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX14 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX15 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX17 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX2 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX21 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX22 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX8 ?y0 ?y1)) (exists (?y0 - object) (AUX0 ?y0)) (exists (?y0 - object) (AUX10 ?y0)) (exists (?y0 - object) (AUX16 ?y0)) (exists (?y0 - object) (AUX18 ?y0)) (exists (?y0 - object) (AUX19 ?y0)) (exists (?y0 - object) (AUX20 ?y0)) (exists (?y0 - object) (AUX23 ?y0)) (exists (?y0 - object) (AUX24 ?y0)) (exists (?y0 - object) (AUX25 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX4 ?y0)) (exists (?y0 - object) (AUX5 ?y0)) (exists (?y0 - object) (AUX7 ?y0)) (exists (?y0 - object) (AUX9 ?y0))))
...
(:derived (ins_passenger_closure ?p - object)
          (or (exists (?y0 - object) (AUX32 ?y0 ?p)) (exists (?y0 - object) (AUX34 ?y0 ?p)) (AUX31 ?p) (AUX33 ?p)))
...
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX73 ?f ?y0)) (exists (?y0 - object) (AUX76 ?f ?y0)) (AUX72 ?f) (AUX74 ?f) (AUX75 ?f) (AUX77 ?f) (AUX78 ?f)))
(:derived (ins_next ?f1 ?f2 - object)
          (or (AUX79 ?f2 ?f1) (ins_next_closure ?f1 ?f2)))
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX80 ?y0 ?y1 ?f1 ?f2)) (AUX81 ?f2 ?f1)))
...
(:derived (AUX80 ?y0 - object ?y1 - object ?f1 - object ?f2 - object)
