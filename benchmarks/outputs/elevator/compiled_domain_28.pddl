...
(:predicates
  ...
  (AUX76 ?f - object)
  (AUX77 ?f - object)
  (AUX78 ?y0 - object ?f - object)
  (AUX79 ?f1 - object ?f2 - object)
  (AUX80 ?f2 - object ?y1 - object ?y0 - object ?f1 - object)
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX8 ?y1 ?y3 ?y0 ?y2)) (exists (?y0 ?y1 - object) (AUX0 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX11 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX12 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX14 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX15 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX17 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX24 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX25 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX5 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX6 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX9 ?y1 ?y0)) (exists (?y0 - object) (AUX1 ?y0)) (exists (?y0 - object) (AUX10 ?y0)) (exists (?y0 - object) (AUX13 ?y0)) (exists (?y0 - object) (AUX16 ?y0)) (exists (?y0 - object) (AUX18 ?y0)) (exists (?y0 - object) (AUX19 ?y0)) (exists (?y0 - object) (AUX2 ?y0)) (exists (?y0 - object) (AUX20 ?y0)) (exists (?y0 - object) (AUX21 ?y0)) (exists (?y0 - object) (AUX22 ?y0)) (exists (?y0 - object) (AUX23 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX4 ?y0)) (exists (?y0 - object) (AUX7 ?y0))))
...
(:derived (ins_passenger_closure ?p - object)
          (or (exists (?y0 - object) (AUX31 ?p ?y0)) (exists (?y0 - object) (AUX34 ?p ?y0)) (AUX32 ?p) (AUX33 ?p)))
...
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX75 ?y0 ?f)) (exists (?y0 - object) (AUX78 ?y0 ?f)) (AUX72 ?f) (AUX73 ?f) (AUX74 ?f) (AUX76 ?f) (AUX77 ?f)))
(:derived (ins_next ?f1 ?f2 - object)
          (or (AUX79 ?f1 ?f2) (ins_next_closure ?f1 ?f2)))
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX80 ?f2 ?y1 ?y0 ?f1)) (AUX81 ?f1 ?f2)))
