...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX7 ?y1 ?y0 ?y3 ?y2)) (exists (?y0 ?y1 - object) (AUX1 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX11 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX12 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX14 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX15 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX16 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX17 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX19 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX2 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX20 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX5 ?y1 ?y0)) (exists (?y0 - object) (AUX0 ?y0)) (exists (?y0 - object) (AUX10 ?y0)) (exists (?y0 - object) (AUX13 ?y0)) (exists (?y0 - object) (AUX18 ?y0)) (exists (?y0 - object) (AUX21 ?y0)) (exists (?y0 - object) (AUX22 ?y0)) (exists (?y0 - object) (AUX23 ?y0)) (exists (?y0 - object) (AUX24 ?y0)) (exists (?y0 - object) (AUX25 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX4 ?y0)) (exists (?y0 - object) (AUX6 ?y0)) (exists (?y0 - object) (AUX8 ?y0)) (exists (?y0 - object) (AUX9 ?y0))))
