...
(:predicates
  ...
  (AUX1 ?y0 - object)
  (AUX2 ?y0 - object)
  (AUX3 ?y3 - object ?y2 - object ?y0 - object ?y1 - object)
  (AUX4 ?y0 - object)
  ...
  (AUX80 ?y1 - object ?y0 - object ?f2 - object ?f1 - object)
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX3 ?y3 ?y2 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX0 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX10 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX11 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX13 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX17 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX18 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX22 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX24 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX5 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX6 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX8 ?y1 ?y0)) (exists (?y0 - object) (AUX1 ?y0)) (exists (?y0 - object) (AUX12 ?y0)) (exists (?y0 - object) (AUX14 ?y0)) (exists (?y0 - object) (AUX15 ?y0)) (exists (?y0 - object) (AUX16 ?y0)) (exists (?y0 - object) (AUX19 ?y0)) (exists (?y0 - object) (AUX2 ?y0)) (exists (?y0 - object) (AUX20 ?y0)) (exists (?y0 - object) (AUX21 ?y0)) (exists (?y0 - object) (AUX23 ?y0)) (exists (?y0 - object) (AUX25 ?y0)) (exists (?y0 - object) (AUX4 ?y0)) (exists (?y0 - object) (AUX7 ?y0)) (exists (?y0 - object) (AUX9 ?y0))))
...
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX80 ?y1 ?y0 ?f2 ?f1)) (AUX81 ?f2 ?f1)))
...
(:derived (AUX3 ?y3 - object ?y2 - object ?y0 - object ?y1 - object)
...
(:derived (AUX80 ?y1 - object ?y0 - object ?f2 - object ?f1 - object)
