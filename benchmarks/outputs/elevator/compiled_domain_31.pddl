...
(:predicates
  ...
  (AUX7 ?y0 - object)
  (AUX8 ?y2 - object ?y0 - object ?y1 - object ?y3 - object)
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX8 ?y2 ?y0 ?y1 ?y3)) (exists (?y0 ?y1 - object) (AUX0 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX10 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX12 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX15 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX16 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX17 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX2 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX20 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX5 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX6 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX9 ?y1 ?y0)) (exists (?y0 - object) (AUX1 ?y0)) (exists (?y0 - object) (AUX11 ?y0)) (exists (?y0 - object) (AUX13 ?y0)) (exists (?y0 - object) (AUX14 ?y0)) (exists (?y0 - object) (AUX18 ?y0)) (exists (?y0 - object) (AUX19 ?y0)) (exists (?y0 - object) (AUX21 ?y0)) (exists (?y0 - object) (AUX22 ?y0)) (exists (?y0 - object) (AUX23 ?y0)) (exists (?y0 - object) (AUX24 ?y0)) (exists (?y0 - object) (AUX25 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX4 ?y0)) (exists (?y0 - object) (AUX7 ?y0))))
...
(:derived (del_floor ?p - object)
          (or (exists (?y0 - object) (AUX49 ?p ?y0)) (exists (?y0 - object) (AUX53 ?p ?y0)) (AUX50 ?p) (AUX51 ?p) (AUX52 ?p) (AUX54 ?p)))
...
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX74 ?f ?y0)) (exists (?y0 - object) (AUX76 ?f ?y0)) (AUX72 ?f) (AUX73 ?f) (AUX75 ?f) (AUX77 ?f) (AUX78 ?f)))
(:derived (ins_next ?f1 ?f2 - object)
          (or (AUX79 ?f2 ?f1) (ins_next_closure ?f1 ?f2)))
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX81 ?y0 ?f2 ?f1 ?y1)) (AUX80 ?f2 ?f1)))
...
(:derived (AUX8 ?y2 - object ?y0 - object ?y1 - object ?y3 - object)
