...
(:predicates
  ...
  (AUX22 ?y0 - object)
  (AUX23 ?y3 - object ?y1 - object ?y0 - object ?y2 - object)
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX23 ?y3 ?y1 ?y0 ?y2)) (exists (?y0 ?y1 - object) (AUX14 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX17 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX18 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX19 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX2 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX21 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX24 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX25 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX4 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX6 ?y0 ?y1)) (exists (?y0 ?y1 - object) (AUX8 ?y0 ?y1)) (exists (?y0 - object) (AUX0 ?y0)) (exists (?y0 - object) (AUX1 ?y0)) (exists (?y0 - object) (AUX10 ?y0)) (exists (?y0 - object) (AUX11 ?y0)) (exists (?y0 - object) (AUX12 ?y0)) (exists (?y0 - object) (AUX13 ?y0)) (exists (?y0 - object) (AUX15 ?y0)) (exists (?y0 - object) (AUX16 ?y0)) (exists (?y0 - object) (AUX20 ?y0)) (exists (?y0 - object) (AUX22 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX5 ?y0)) (exists (?y0 - object) (AUX7 ?y0)) (exists (?y0 - object) (AUX9 ?y0))))
...
(:derived (AUX23 ?y3 - object ?y1 - object ?y0 - object ?y2 - object)
