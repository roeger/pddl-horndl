...
(:predicates
  ...
  (AUX14 ?y2 - object ?y1 - object ?y3 - object ?y0 - object)
  (AUX15 ?y0 - object)
  ...
  (AUX81 ?f2 - object ?y1 - object ?f1 - object ?y0 - object)
  (AUX82 ?x - object))
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX14 ?y2 ?y1 ?y3 ?y0)) (exists (?y0 ?y1 - object) (AUX0 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX13 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX16 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX17 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX19 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX23 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX4 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX5 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX7 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX8 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX9 ?y1 ?y0)) (exists (?y0 - object) (AUX1 ?y0)) (exists (?y0 - object) (AUX10 ?y0)) (exists (?y0 - object) (AUX11 ?y0)) (exists (?y0 - object) (AUX12 ?y0)) (exists (?y0 - object) (AUX15 ?y0)) (exists (?y0 - object) (AUX18 ?y0)) (exists (?y0 - object) (AUX2 ?y0)) (exists (?y0 - object) (AUX20 ?y0)) (exists (?y0 - object) (AUX21 ?y0)) (exists (?y0 - object) (AUX22 ?y0)) (exists (?y0 - object) (AUX24 ?y0)) (exists (?y0 - object) (AUX25 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX6 ?y0))))
...
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX81 ?f2 ?y1 ?f1 ?y0)) (AUX80 ?f2 ?f1)))
...
(:derived (AUX14 ?y2 - object ?y1 - object ?y3 - object ?y0 - object)
...
(:derived (AUX81 ?f2 - object ?y1 - object ?f1 - object ?y0 - object)
