...
(:predicates
  ...
  (AUX15 ?y1 - object ?y0 - object ?y2 - object ?y3 - object)
  ...
  (AUX81 ?f1 - object ?y0 - object ?f2 - object ?y1 - object)
  (AUX82 ?x - object))
...
(:derived (incompatible_update)
          (or (exists (?y0 ?y1 ?y2 ?y3 - object) (AUX15 ?y1 ?y0 ?y2 ?y3)) (exists (?y0 ?y1 - object) (AUX1 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX12 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX14 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX16 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX19 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX2 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX23 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX24 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX5 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX8 ?y1 ?y0)) (exists (?y0 ?y1 - object) (AUX9 ?y1 ?y0)) (exists (?y0 - object) (AUX0 ?y0)) (exists (?y0 - object) (AUX10 ?y0)) (exists (?y0 - object) (AUX11 ?y0)) (exists (?y0 - object) (AUX13 ?y0)) (exists (?y0 - object) (AUX17 ?y0)) (exists (?y0 - object) (AUX18 ?y0)) (exists (?y0 - object) (AUX20 ?y0)) (exists (?y0 - object) (AUX21 ?y0)) (exists (?y0 - object) (AUX22 ?y0)) (exists (?y0 - object) (AUX25 ?y0)) (exists (?y0 - object) (AUX3 ?y0)) (exists (?y0 - object) (AUX4 ?y0)) (exists (?y0 - object) (AUX6 ?y0)) (exists (?y0 - object) (AUX7 ?y0))))
...
(:derived (del_floor ?p - object)
          (or (exists (?y0 - object) (AUX51 ?p ?y0)) (exists (?y0 - object) (AUX53 ?p ?y0)) (AUX49 ?p) (AUX50 ?p) (AUX52 ?p) (AUX54 ?p)))
...
(:derived (del_liftat ?f - object)
          (or (exists (?y0 - object) (AUX73 ?y0 ?f)) (exists (?y0 - object) (AUX77 ?y0 ?f)) (AUX72 ?f) (AUX74 ?f) (AUX75 ?f) (AUX76 ?f) (AUX78 ?f)))
(:derived (ins_next ?f1 ?f2 - object)
          (or (AUX79 ?f1 ?f2) (ins_next_closure ?f1 ?f2)))
(:derived (del_next ?f1 ?f2 - object)
          (or (exists (?y0 ?y1 - object) (AUX81 ?f1 ?y0 ?f2 ?y1)) (AUX80 ?f1 ?f2)))
...
(:derived (AUX15 ?y1 - object ?y0 - object ?y2 - object ?y3 - object)
...
(:derived (AUX81 ?f1 - object ?y0 - object ?f2 - object ?y1 - object)
