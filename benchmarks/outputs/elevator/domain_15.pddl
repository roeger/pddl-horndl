...
(:derived (updating )
          (del_liftat_request ?y0))
(:derived (updating )
          (del_floor_request ?y0))
(:derived (del_served ?x0 - object)
