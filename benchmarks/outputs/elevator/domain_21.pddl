...
(:derived (compatible_update)
          (forall (Y0 Y1) (and (or (not (del_boarded_request Y0)) (not (ins_boarded_request Y0))) (or (not (del_destin_request Y0 Y1)) (not (ins_destin_request Y0 Y1))) (or (not (del_floor_request Y0)) (not (ins_destin_request Y1 Y0))) (or (not (del_floor_request Y0)) (not (ins_floor_request Y0))) (or (not (del_floor_request Y0)) (not (ins_liftat_request Y0))) (or (not (del_floor_request Y0)) (not (ins_origin_request Y1 Y0))) (or (not (del_liftat_request Y0)) (not (ins_liftat_request Y0))) (or (not (del_next_request Y0 Y1)) (not (ins_next_request Y0 Y1))) (or (not (del_origin_request Y0 Y1)) (not (ins_origin_request Y0 Y1))) (or (not (del_passenger_request Y0)) (not (ins_boarded_request Y0))) (or (not (del_passenger_request Y0)) (not (ins_destin_request Y0 Y1))) (or (not (del_passenger_request Y0)) (not (ins_origin_request Y0 Y1))) (or (not (del_passenger_request Y0)) (not (ins_passenger_request Y0))) (or (not (del_passenger_request Y0)) (not (ins_served_request Y0))) (or (not (del_served_request Y0)) (not (ins_served_request Y0))) (or (not (ins_boarded_request Y0)) (not (ins_floor_request Y0))) (or (not (ins_boarded_request Y0)) (not (ins_liftat_request Y0))) (or (not (ins_destin_request Y0 Y1)) (not (ins_floor_request Y0))) (or (not (ins_destin_request Y0 Y1)) (not (ins_liftat_request Y0))) (or (not (ins_floor_request Y0)) (not (ins_origin_request Y0 Y1))) (or (not (ins_floor_request Y0)) (not (ins_passenger_request Y0))) (or (not (ins_floor_request Y0)) (not (ins_served_request Y0))) (or (not (ins_liftat_request Y0)) (not (ins_origin_request Y0 Y1))) (or (not (ins_liftat_request Y0)) (not (ins_passenger_request Y0))) (or (not (ins_liftat_request Y0)) (not (ins_served_request Y0))))))
