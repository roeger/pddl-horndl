...
(:predicates
  ...
  (AUX7 ?y0 - object)
  (AUX8 ?y0 - object)
  (AUX9 ?x3 - object ?x2 - object ?x1 - object)
  (AUX10 ?x3 - object ?x2 - object ?x1 - object)
...
(:action hireElectronicEng
  ...
  :effect (when (forall (?x1 ?x2 ?x3 - object) (AUX9 ?x3 ?x2 ?x1)) (electronicengineer ?n)))
(:action hireInformaticEng
  :parameters (?n - object)
  :precondition (not (DATALOG_INCONSISTENT))
  :effect (when (forall (?x1 ?x2 ?x3 - object) (AUX10 ?x3 ?x2 ?x1)) (informaticengineer ?n)))
