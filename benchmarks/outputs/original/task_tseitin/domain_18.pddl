...
(:predicates
  ...
  (AUX7 ?y0 - object)
  (AUX8 ?y0 - object)
  (AUX9 ?x1 - object ?x2 - object ?x3 - object)
  (AUX10 ?x1 - object ?x2 - object ?x3 - object)
...
(:action hireElectronicEng
  ...
  :effect (when (forall (?x1 ?x2 ?x3 - object) (AUX9 ?x1 ?x2 ?x3)) (electronicengineer ?n)))
(:action hireInformaticEng
  :parameters (?n - object)
  :precondition (not (DATALOG_INCONSISTENT))
  :effect (when (forall (?x1 ?x2 ?x3 - object) (AUX10 ?x1 ?x2 ?x3)) (informaticengineer ?n)))
