...
(:predicates
  ...
  (AUX0 ?x0 - object ?y0 - object ?x1 - object)
...
(:derived (DATALOG_VERINLINE ?x0 ?x1 - object)
          (or (exists (?y0 - object) (AUX0 ?x0 ?y0 ?x1)) (DATALOG_VERINLINE ?x1 ?x0) (verinline ?x0 ?x1)))
(:derived (DATALOG_RIGHTDIAGONAL ?x0 ?x1 - object)
          (or (exists (?y0 - object) (AUX1 ?x0 ?y0 ?x1)) (DATALOG_RIGHTDIAGONAL ?x1 ?x0) (rightdiagonal ?x0 ?x1)))
(:derived (DATALOG_HORINLINE ?x0 ?x1 - object)
          (or (exists (?y0 - object) (AUX2 ?x0 ?y0 ?x1)) (DATALOG_HORINLINE ?x1 ?x0) (horinline ?x0 ?x1)))
(:derived (DATALOG_BACKDIAGONAL ?x0 ?x1 - object)
          (or (exists (?y0 - object) (AUX3 ?x0 ?y0 ?x1)) (DATALOG_BACKDIAGONAL ?x1 ?x0) (backdiagonal ?x0 ?x1)))
(:derived (DATALOG_FIGURE ?x0 - object)
          (or (figure ?x0) (queen ?x0)))
(:derived (AUX0 ?x0 - object ?y0 - object ?x1 - object)
