...
(:derived (DATALOG_HORINLINE ?x0 ?x1 - object)
          (or (exists (?y0 - object) (AUX0 ?y0 ?x1 ?x0)) (DATALOG_HORINLINE ?x1 ?x0) (horinline ?x0 ?x1)))
...
(:derived (DATALOG_RIGHTDIAGONAL ?x0 ?x1 - object)
          (or (exists (?y0 - object) (AUX2 ?y0 ?x1 ?x0)) (DATALOG_RIGHTDIAGONAL ?x1 ?x0) (rightdiagonal ?x0 ?x1)))
(:derived (DATALOG_FIGURE ?x0 - object)
          (or (figure ?x0) (queen ?x0)))
(:derived (DATALOG_VERINLINE ?x0 ?x1 - object)
          (or (exists (?y0 - object) (AUX3 ?y0 ?x1 ?x0)) (DATALOG_VERINLINE ?x1 ?x0) (verinline ?x0 ?x1)))
